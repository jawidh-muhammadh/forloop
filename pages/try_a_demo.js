...
const Try_a_demo = () => {
  ...
  return (
    <div>
      <div>
        <h1 className=" font-Productsansbold sm:font-Productsansregular sm:leading-normal leading-[36px] sm:text-[45px] sm:mx-0 mx-10 text-[30px] sm:text-center pt-[60px]  sm:pt-[130px]">
          {" "}
          Play around to see how our app works.{" "}
        </h1>
        <h1 className=" font-Productsansbold sm:font-Productsansregular sm:leading-normal leading-[36px]   sm:text-[45px] sm:mx-0 mx-10 text-[30px] sm:text-center ">
          {" "}
          You gonna see magic for sure.{" "}
        </h1>
        ...
        <div className="sm:flex hidden  mt-10 justify-center">
          <div onClick={() => router.push("/Email_demo")} className=" mx-8 ">
            <div className=" border cursor-pointer hover:shadowdemocard border-[#D1D1D1] rounded-[16px]  px-8 pt-4">
              <img
                className=" w-[152px]  "
                src="/images/saturday/Mailing.png"
              />
            </div>
          ...
          >
            <div className=" border cursor-pointer hover:shadowdemocard border-[#D1D1D1] rounded-[16px] px-8 pt-4">
              <img
                className=" w-[152px]  "
                src="/images/saturday/write_a_letter.png"
              />
            </div>
          ...
          <div
            onClick={() => router.push("/write_story_demo")}
            className=" mx-8"
          >
            <div className=" border cursor-pointer hover:shadowdemocard border-[#D1D1D1] rounded-[16px]  px-8 pt-4">
              <img
                className=" w-[152px]  "
                src="/images/saturday/Write_a_story.png"
              />
            </div>
        ...
        <div className="sm:flex hidden  mt-10 justify-center">
          ...
          >
            <div className=" border cursor-pointer hover:shadowdemocard border-[#D1D1D1] rounded-[16px]  px-8 pt-4">
              <img
                className=" w-[152px]  "
                src="/images/saturday/prepare_tutes.png"
              />
            </div>
          ...
          >
            <div className=" border cursor-pointer hover:shadowdemocard border-[#D1D1D1] rounded-[16px] px-8 pt-4">
              <img
                className=" w-[152px]  "
                src="/images/saturday/Mind_maping.png"
              />
            </div>
      ...
      <img
        className=" sm:block hidden absolute bottom-0 right-0 w-[400px] h-[400px]  "
        src="/images/saturday/doodle8.png"
      />
    </div>
  );
};
