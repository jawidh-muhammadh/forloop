...
//         <h1 className=' px-4   font-Productsansbold text-[30px]'> Paste Paragraph Here  </h1>
...
//       <button onClick={() => router.push('/paragraph_sum_generate')} className=' py-2 px-12 rounded-full text-white font-Productsansbold bg-[#118AB2]'>  Generate </button>
//       </div>
...
//       <h1 className='  mx-9    font-Productsansbold text-[25px] mt-12'>  Paste Paragraph Here  </h1>
