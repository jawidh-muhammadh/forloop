...
//       <img onClick={() => router.push('/try_a_demo')} className=" cursor-pointer w-10 sm:pt-24 ml-20  " src="/images/left_arrow.png" />
...
//       <h1 className=' text-left mx-9 mt-7    font-Productsansbold text-[25px]'>  Email Type  </h1>
