...
const Mindmap_map_generate = () => {
  ...
  return (
    ...
    <div className=' h-screen'>
      <img onClick={() => router.push('/mindmap_map_demo')} className="  cursor-pointer w-10 pt-64 ml-20  " src="/images/left_arrow.png" />
      

      <h1 className=' font-Productsansbold mt-5 text-[40px] ml-[170px] '> Here you go! MINDMAP  </h1>
