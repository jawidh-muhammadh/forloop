  ...
  return (
    <>
      <div className=" sm:text-center h-screen ">
        {/* large device  */}
        <h1 className=" sm:pt-[214px] sm:block hidden text-[#A2A2A2] text-[60px] font-Productsansbold">
          {" "}
          Hey! We're working on it.{" "}
        </h1>
        <h1 className="text-[#080808] hidden sm:block text-[50px] mx-auto  max-w-[800px] font-Productsansbold">
          {" "}
        ...
        <div className="sm:hidden mt-16 mx-8 ">
          <h1 className=" text-[#A2A2A2] sm:hidden font-Productsansbold leading-[35px] text-[33px]  pt-12">
            {" "}
            Hey!{" "}
          </h1>
          <h1 className="text-[#A2A2A2] sm:hidden font-Productsansbold leading-[35px] text-[33px]">
            {" "}
            we are working{" "}
          </h1>
          <h1 className="text-[#A2A2A2] sm:hidden font-Productsansbold leading-[35px] text-[33px]">
     ...
     <button className=''>  hello </button>
        ...
        <div className=" sm:hidden text-right mt-5 mx-2 ">
          <h1 className=" font-Productsansbold text-[30px] leading-[30px] ">
            {" "}
            We look forward to{" "}
          </h1>
          <h1 className="font-Productsansbold text-[30px] leading-[30px] ">
        ...
        <div className="sm:flex hidden justify-center   items-center  ">
          <div className="relative">
            <input
              ...
              className="w-[500px] pr-24 mx-auto  outline-transparent pl-7 text-[#B5B5B5] mt-6 h-[50px] rounded-[40px] bg-[#ECECEC] "
            />
            <div className="absolute top-[25px] text-center right-[110px]  ">
              ...
              <button
                disabled={!userinfotype}
                onClick={saveuserinfo}
                className=" bg-[#080808] cursor-pointer text-center absolute text-white w-28 py-3 rounded-[40px]      "
              >
                {" "}
                Notify Me{" "}
              </button>
     ...
     <button className=' bg-[#080808] cursor-pointer text-center absolute text-white w-24 py-2 rounded-[40px] '>   Notify Me </button>
        ...
        <div className="flex sm:hidden relative mx-auto mt-8 w-80 rounded-full  bg-[#ECECEC] text-[14px] md:w-80 border p-2 border-[#F2F1EB] ">
          ...
          <button
            disabled={!userinfotype}
            onClick={saveuserinfo}
            className="  rounded-full bg-[#080808] absolute py-[10px] -mt-[8px]  -mr-[1px] text-[14px]         text-white right-0    px-5"
          >
            {" "}
            Submit
          </button>
     ...
     <img className=" w-6  " src="/images/right_arrow.png" />
        ...
        <h1
          className={`text-center sm:mx-0 mx-5   ${
            showsubscribedone ? "block" : "hidden"
          }  text-2xl z-50 pt-7 sm:pt-4 font-Productsansregular text-green-900`}
        >
          {" "}
          Thank You. We will notify you our launch day soon{" "}
        </h1>
      </div>
