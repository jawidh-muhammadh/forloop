...
<div className=' h-screen'>
      <img onClick={() => router.push('/paragraph_sum_demo')} className=" z-50  cursor-pointer w-10 pt-24 sm:pt-64 sm:ml-20 ml-10  " src="/images/left_arrow.png" />
      

      <h1 className=' font-Productsansbold mt-5 text-[40px] mx-6 sm:mx-0 sm:ml-[170px] '> Here you go! paragraph  </h1>
