  ...
  return (
    <div className="mt-20 mb-44 sm:mb-32 sm:mt-44 downloadimagesmall sm:downloadimage ">
      ...
      <div className="mt-6 text-center sm:hidden 2xl:mt-12 md:mt-8 md:mr-2 sm:mt-5 md:mx-0">
        <button className="bg-[#1B1212]    hover:bg-[#1b1919]  md:hover:transition md:duration-300 md:ease-in-out md:delay-150 md:hover:scale-105 text-base          px-16  font-Productsansbold rounded-full py-3 2xl:py-5  text-white font-semibold">
          Download Now
        </button>
      </div>
    </div>
