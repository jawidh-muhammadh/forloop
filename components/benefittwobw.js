    ...
    <>
      <div className="justify-between hidden mt-20 sm:flex">
        <div className=" w-6/12 sm:h-[450px]  md:h-[600px] dark:bg-[#23262E]  bg-[#f3eef3]">
          ...
          {/* <h1 className="mx-16 mt-6 text-xl text-center font-Productsansregular">
          {" "}
          Give extra detailing even if you are not that good in english.Simply
          type what you have in your mind as comma seperated keywords. Forloop
          will work beyond expectations.Broken english is always welcome{" "}
        </h1> */}
        </div>
      ...
      <div className="relative flex justify-between mt-20 sm:hidden ">
        <div className=" w-full h-[350px] dark:bg-[#23262E]   bg-[#f3eef3]">
          <h1 className=" mt-5 ml-[21px] mx-6 leading-[75px] dark:text-white  text-[35px] font-Productsansbold text-[#707070]">
            {" "}
            You can now
          </h1>
          <h1 className="  mx-6 ml-[27px] leading-[15px] dark:text-white   text-[35px] font-Productsansbold text-[#707070]">
            {" "}
            explain
          </h1>
          <h1 className="  mx-6 ml-[27px] leading-[75px] dark:text-white   text-[35px] font-Productsansbold text-[#707070]">
            {" "}
            what's in your
          </h1>
          <h1 className="  mx-6 ml-[27px] leading-[15px] dark:text-white   text-[35px] font-Productsansbold text-[#707070]">
