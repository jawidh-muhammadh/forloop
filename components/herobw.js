...
const Herobw = () => {
  return (
    <>
      <div className="flex flex-col dark:bg-[#1B1F24] #080808 items-center sm:justify-between md:flex md:flex-row">
        {/* bg-[#F2F2F2]  */}
        <div className="order-2 ml-0 mr-0 md:mx-auto xl:mx-auto lg:mx-auto md:order-1">
          ...
          <h1 className=" mt-6 sm:mt-4 mx-[2px] sm:mx-0 text-4xl text-center dark:text-[#cac3c3] md:dark:text-white  text-[#807878] md:text-black sm:text-5xl md:text-left md:text-6xl lg:text-7xl xl:text-7xl 2xl:text-9xl font-Productsansbold ">
            {" "}
            The app for making{" "}
          </h1>
          ...
          <h1 className="mt-2 dark:text-[#cac3c3] md:dark:text-white mx-[2px] sm:mx-0 text-4xl text-[#807878] text-center md:text-black xl:text-7xl 2xl:text-9xl sm:text-5xl md:text-left md:text-6xl lg:text-7xl font-Productsansbold ">
            {" "}
          ...
          <h1 className="mt-5  2xl:mt-11 sm:text-center w-full px-10 sm:px-4 md:px-0 lg:px-4 xl:px-2   text-center  2xl:text-4xl     sm:mx-5 md:mx-0 text-sm sm:text-xl xl:text-xl md:text-left text-[#c9c4c4] sm:dark:text-white sm:text-black md:w-[500px]  2xl:w-[1050px]  lg:w-[650px] font-Productsansregular  tracking-wide">
            {" "}
          ...
          <div className="mt-12 text-center 2xl:mt-12 md:mt-8 md:mr-2 md:flex sm:mt-5 md:mx-0">
            <button className="bg-[#1B1212] dark:bg-white dark:hover:bg-[#eee8e8]    hover:bg-[#1b1919]  md:hover:transition md:duration-300 md:ease-in-out md:delay-150 md:hover:scale-105 sm:text-lg 2xl:text-2xl         px-24  font-Productsansbold rounded-full py-3 2xl:py-5 dark:text-black  text-white font-semibold">
              Get Started
            </button>
          </div>
        </div>
        <div className="order-1 ml-1 sm:ml-6 md:order-2 md:mx-auto lg:mx-auto xl:mx-auto ">
          <img
            className="w-32 sm:w-32 sm:mt-11 md:mt-24 xl:mt-16 md:w-40 lg:w-56 2xl:w-96"
      ...
      <div className="md:flex dark:bg-[#1B1F24]  hidden   mt-[37px] justify-between">
